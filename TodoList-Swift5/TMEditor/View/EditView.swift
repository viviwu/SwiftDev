...
class EditView: UIView {
  ...
  func reloadInitialText() {
    ...
    @objc func handleStartEditingButtonTapped(sender: UIButton) {
    textField.becomeFirstResponder()
    stickyView.textField.becomeFirstResponder()
  }
  
    @objc func handleEditButtonTapped(sender: UIButton) {
    hideKeyboard()
    editButtonTappedHandler?()
  }
  
    @objc func handleSaveButtonTapped(sender: UIButton) {
    done()
  }
  ...
  var placeholder: String? {
    set {
      ...
      textField.attributedPlaceholder = NSAttributedString(
        string: string,
        attributes: [
            NSAttributedString.Key.font: Specs.font.regular as Any,
            NSAttributedString.Key.foregroundColor: Specs.color.gray
        ]
      )
    }
    get {
