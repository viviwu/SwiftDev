...
extension StickyView {
  ...
  func initial() {
    ...
    @objc func handleAlarmButtonTapped(sender: UIButton) {
    if mode != .date {
      showDatePicker()
    } else {
      hideDatePicker()
    ...
    @objc func handleListButtonTapped(sender: UIButton) {
    if mode != .list {
      showListPicker()
    } else {
      hideListPicker()
    ...
    @objc func handleDatePickerValueChanged(sender: UIDatePicker) {
